...
/* SauceConnect */ sauceConnect, browserMap, logger, baseLauncherDecorator, captureTimeoutLauncherDecorator, retryLauncherDecorator) {
    ...
    const uploadJobResult = (browserData, browserName) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            // 1. Create a tmp dir
            fs_extra_1.mkdirSync(sessionId);
            fs_extra_1.writeFileSync(`${sessionId}/log.json`, JSON.stringify(results, null, 2));
            // 2. Update the log assets
            // @ts-ignore
            yield api.uploadJobAssets(sessionId, { files: [`${sessionId}/log.json`] });
            // 3. remove the temporary folder
            fs_extra_1.removeSync(sessionId);
